define(['../core/transport/main', './identity', '../core/subscribe'], function (transport, identity, subscribe) {
  ...
  return {
    ...
    follow: function (performer, callback) {
      transport.connection.post('/follow', {username: performer}, function (error, response) {
        if (response.error) {
          return callback(response);
        }
    ...
    following: function (callback) {
      transport.connection.get('/follow', function (error, response) {
        if (response.error) {
          return callback(response);
        }
    ...
    isFollowing: function (performer, callback) {
      transport.connection.get('/follow', {username: performer}, function (error, response) {
        if (response.error) {
          return callback(response);
        }
    ...
    unFollow : function (performer, callback) {
      transport.connection.delete('/follow/' + performer, function (error, response) {
        if (response.error) {
          return callback(response);
        }
