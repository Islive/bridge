define([
  ...
  return {
    ...
    create: function (to, subject, message, callback) {
      ...
      user.getIdentity(function (error) {
        if (error) {
          return callback(error);
        }

        transport.connection.post('/thread', thread, function (error, response) {
          if (error) {
            return callback(error);
          }
    ...
    getThread: function (threadId, callback) {
      transport.connection.get('/thread', {id: threadId}, function (error, response) {
        if (error) {
          return callback(error);
        }
    ...
    reply: function (thread, message, callback) {
      ...
      user.getIdentity(function (error) {
        ...
        transport.connection.post('/message', {thread: thread, body: message}, function (error, response) {
          if (error) {
            return callback(error);
          }
    ...
    markAllRead: function (thread, callback) {
      ...
      transport.connection.put('/message/by-thread/' + threadId, {read: true}, function (error, response) {
        if (error) {
          return callback(error);
        }
    ...
    markRead: function (message, callback) {
      ...
      transport.connection.put('/message/' + message, {read: true}, function (error, response) {
        if (error) {
          return callback(error);
        }
    ...
    inbox: function (callback) {
      user.getIdentity(function (error, identity) {
        ...
        transport.connection.get('/message/inbox', function (error, response) {
          if (error) {
            return callback(error);
          }
